      ...
      body: RefreshIndicator(
        ...
        child: ListView(
            ...
            children: [ Column(
              children: [
                SizedBox(height: 10,),
                Text("Kategorini Belirle", style: GoogleFonts.raleway(
                ...
                Divider(height: 5,),
                SizedBox(height: 15,),
                Text("Sevilen İlanlar", style: GoogleFonts.raleway(
                    fontSize: 20, color: Colors.black.withOpacity(0.5)),),
                SizedBox(height: 5,),
                StreamBuilder(
                ...
                Divider(height: 5,),
                SizedBox(height: 10,),
                Text("Göz Attıkların", style: GoogleFonts.raleway(
                    fontSize: 20, color: Colors.black.withOpacity(0.5)),),
    StreamBuilder(
          ...
          children: [
            Padding(
              ...
              child: Container(
                ...
                Divider(height: 5,),
                SizedBox(height: 15,),
                Text("Yakınınızdaki İlanlar", style: GoogleFonts.raleway(
                    fontSize: 20, color: Colors.black.withOpacity(0.5)),),
                SizedBox(height: 10),
                Container(
                  height: 200,
